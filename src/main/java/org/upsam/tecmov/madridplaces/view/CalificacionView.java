...
public class CalificacionView implements Serializable {
	...
	/**
	 * Valor m�nimo del rango de peligrosidad
	 */
	private Integer min;
	/**
	 * Valor m�ximo del rango de peligrosidad
	 */
	private Integer max;
	/**
	 * C�digo postal al que se refiere la calificaci�n
	 */
